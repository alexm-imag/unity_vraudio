...
\newline
\newline
% Rework this into something more general
% Idea: the assets shall be interchangable
% However to avoid too complicated asset import procedures some conventions will have to be established, like file or folder name and structure guidelines.
